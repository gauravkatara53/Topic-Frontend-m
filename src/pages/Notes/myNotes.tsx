...
import { handleDeleteNote } from "@/services/noteService";

const branches = ["MME", "CSE", "EE", "ME", "CE", "ECM", "PIE", "ECE"];

const MyNotesSearchPage = () => {
  const { user } = useAuth();
                          ...
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                              ...
                              onClick={async () => {
                                if (deleteId) {
                                  try {
                                    await handleDeleteNote(deleteId);
                                    setNotes((note) =>
                                      note.filter((p) => p._id !== deleteId)
                                    );
                                  } catch (error) {
                                  } finally {
                                    setDeleteId(null);
...
export default MyNotesSearchPage;
